...
const BINDINGS: &[Binding] = &[
    Binding {
        key: BindingKey::Code(KeyCode::Tab),
        action: Action::NextView,
        display: "Tab",
        primary: true,
    },
    Binding {
        key: BindingKey::Code(KeyCode::BackTab),
        action: Action::PreviousView,
        display: "Shift+Tab",
        primary: true,
    },
    Binding {
        key: BindingKey::Code(KeyCode::F(6)),
        action: Action::CycleTheme,
        display: "F6",
        primary: true,
    },
    Binding {
        key: BindingKey::Code(KeyCode::Char('q')),
        action: Action::Quit,
        display: "q",
        primary: true,
    },
    Binding {
        key: BindingKey::Code(KeyCode::Esc),
        action: Action::Quit,
        display: "Esc",
        primary: false,
    },
    Binding {
        key: BindingKey::Code(KeyCode::Char(' ')),
        action: Action::TogglePlayback,
        display: "Space",
        primary: true,
    },
    Binding {
        key: BindingKey::Code(KeyCode::Char('n')),
        action: Action::NextTrack,
        display: "n",
        primary: false,
    },
    Binding {
        key: BindingKey::Code(KeyCode::Char('l')),
        action: Action::NextTrack,
        display: "l",
        primary: true,
    },
    Binding {
        key: BindingKey::Code(KeyCode::Right),
        action: Action::NextTrack,
        display: "→",
        primary: false,
    },
    Binding {
        key: BindingKey::Code(KeyCode::Char('p')),
        action: Action::PreviousTrack,
        display: "p",
        primary: false,
    },
    Binding {
        key: BindingKey::Code(KeyCode::Char('h')),
        action: Action::PreviousTrack,
        display: "h",
        primary: true,
    },
    Binding {
        key: BindingKey::Code(KeyCode::Left),
        action: Action::PreviousTrack,
        display: "←",
        primary: false,
    },
    ...
    Binding {
        key: BindingKey::Code(KeyCode::Char('s')),
        action: Action::ToggleShuffle,
        display: "s",
        primary: true,
    },
    Binding {
        key: BindingKey::Code(KeyCode::Char('r')),
    ...
    Binding {
        key: BindingKey::Code(KeyCode::Char('/')),
        action: Action::SetView(View::Search),
        display: "/",
        primary: true,
    },
    Binding {
        key: BindingKey::Code(KeyCode::Char('e')),
        action: Action::SetView(View::Editor),
        display: "e",
        primary: true,
    },
    Binding {
        key: BindingKey::Code(KeyCode::Char('y')),
        action: Action::SetView(View::Lyrics),
        display: "y",
        primary: true,
    },
    Binding {
        key: BindingKey::AltChar('1'),
        action: Action::SetView(View::NowPlaying),
        display: "Alt+1",
        primary: true,
    },
    Binding {
        key: BindingKey::AltChar('2'),
        action: Action::SetView(View::Search),
        display: "Alt+2",
        primary: false,
    },
    Binding {
        key: BindingKey::AltChar('3'),
        action: Action::SetView(View::Playlist),
        display: "Alt+3",
        primary: true,
    },
    Binding {
        key: BindingKey::AltChar('4'),
        action: Action::SetView(View::Lyrics),
        display: "Alt+4",
        primary: false,
    },
    Binding {
        key: BindingKey::AltChar('5'),
        action: Action::SetView(View::Editor),
        display: "Alt+5",
        primary: false,
    },
...
fn binding_matches(binding: BindingKey, key: KeyEvent) -> bool {
    match binding {
        ...
        BindingKey::Code(code) => !key.modifiers.contains(KeyModifiers::ALT) && key.code == code,
    }
}
